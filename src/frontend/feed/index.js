...
const Feed = () => {
	...
	return (
		<div className="wporg-meeting-calendar__feed">
			<p>{ __( 'Events are shown in your local time zone', 'wporg-meeting-calendar' ) }</p>
			<p>{ __( 'Subscribe to this calendar:', 'wporg-meeting-calendar' ) } <a href={ getGoogleCalendarUrl() }>Google Calendar ↗</a> · <a href={ getCalendarUrl() }>ICS</a></p>
		</div>
	);
};
